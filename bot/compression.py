...
class ConversationCompressor:
    ...
    def compress_history(
        ...
        Args:
            conversation_history: List of message dicts with 'username' and 'content'
        ...
        if not self._enabled:
            ...
            return self._format_uncompressed(conversation_history)
        ...
        if not history_text.strip():
            return self._format_uncompressed(recent_messages)
        ...
        try:
            ...
            result = f"[Earlier conversation (compressed)]:\n{compressed_text}\n\n[Recent messages]:\n"
            result += "\n".join([
                f"{msg.get('username', 'User')}: {msg.get('content', '')}"
    ...
    def _format_uncompressed(self, conversation_history: List[Dict]) -> str:
